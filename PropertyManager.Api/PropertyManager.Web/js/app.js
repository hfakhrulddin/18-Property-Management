...
angular.module('app').config(function ($stateProvider, $urlRouterProvider) {
    ...
    .state('property.detail', { url: '/detail/:id', templateUrl: '/templates/property/property.detail.html', controller: 'PropertyDetailController' })
        .state('property.add', { url: '/add', templateUrl: '/templates/property/property.add.html', controller: 'PropertyAddController' })
    ...
    .state('lease.detail', { url: '/detail/:id', templateUrl: '/templates/lease/lease.detail.html', controller: 'LeaseDetailController' })
        .state('lease.add', { url: '/add', templateUrl: '/templates/lease/lease.add.html', controller: 'LeaseAddController' })
...
.state('tenant.add', { url: '/add', templateUrl: '/templates/tenant/tenant.add.html', controller: 'TenantAddController' })
    ...
    .state('workorder.add', { url: '/add', templateUrl: '/templates/workorder/workorder.add.html', controller: 'WorkorderAddController' })
